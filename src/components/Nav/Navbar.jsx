        ...
        <div className="flex items-center gap-10">
          <div className="flex gap-10">
            ...
            <Link onClick={goTop} to="/signup" title="signup_button">
              <i className="fa-regular fa-user  text-white text-4xl cursor-pointer hover:text-[#FF0336] ease-in duration-200" id="btn_special" style={{display: active==='user' || active==='admin'? 'none':''}}></i>
            </Link>
            {/* <Link onClick={goTop} to="/signup" title="signup_button">
              <i className="fa-regular fa-arrow-right-from-bracket text-white text-4xl cursor-pointer hover:text-[#FF0336] ease-in duration-200" id="btn_special" style={{display: active==='user'? 'none':''}} ></i>
            </Link> */}
            {/* sidebar */}
            <i
              onClick={sideBar}
